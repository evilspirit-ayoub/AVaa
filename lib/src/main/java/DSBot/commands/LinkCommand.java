...
public class LinkCommand {
	...
	public static void link(String[] args, Guild guild, String guildName, Message message, MessageChannel channel) throws ClassNotFoundException, IOException, InterruptedException {
