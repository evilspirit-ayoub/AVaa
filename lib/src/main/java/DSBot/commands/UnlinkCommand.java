...
public class UnlinkCommand {
	...
	public static void unlink(String[] args, Guild guild, String guildName, Message message, MessageChannel channel) throws ClassNotFoundException, IOException, InterruptedException {
